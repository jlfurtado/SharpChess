...
{   
     /// <summary>
     /// Static class that exposes functionality to place pieces based on regular chess rules
     /// </summary>
    public static class ChessPlacer
    {
        /// <summary>
        /// Places the white player's pieces for a standard chess game, returns the king to be set
        /// </summary>
        ...
        /// <summary>
        /// Places the black player's pieces for a standard chess game, returns the king to be set
        /// </summary>
        /// <param name="player">Reference to the player object</param>
